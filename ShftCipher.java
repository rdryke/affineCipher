...
public class ShftCipher {
    ...
    public static void main(String[] args) {
       ShftCipher cphr = new ShftCipher();
        cphr.start();
    ...
    public Hashtable<Integer, Hashtable<Integer,Integer>> bestguess()
    {
        ...
        Hashtable<String,Integer> frequencytable = readfile();
...
//                        System.out.println(word);
    ...
    public Hashtable<String,Integer> readfile()
    {
        Hashtable<String,Integer> table = new Hashtable<>();
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Rob\\Downloads3\\enable1.txt")))
		{
